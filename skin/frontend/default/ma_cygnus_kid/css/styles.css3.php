...
.tab_content_newarrivals .bx-wrapper .bxslider .item:hover .actions .actions-inner, .featuredproductslider-item:hover .actions .actions-inner, .products-grid .item .item-inner:hover .actions .actions-inner{
    opacity: 1;
    -webkit-opacity: 1;
    -moz-opacity: 1;
}
